...
parser.add_argument("--save_generations", type = str, default = 'data/mistral.json')
parser.add_argument("--model_path", type = str, default = "mistralai/Mistral-7B-Instruct-v0.1")
...
PROMPT_DICT = {
    "prompt_no_input" : "<s>[INST] {instruction} [/INST]"
}
