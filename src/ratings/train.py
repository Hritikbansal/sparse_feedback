...
class ScriptArguments:
    ...
    per_device_train_batch_size: Optional[int] = field(default=3)
    ...
    num_train_epochs: Optional[int] = field(default="5", metadata={"help": "The number of training epochs for the reward model. OpenAI used 5."})
    ...
    train_input_csv: Optional[str] = field(default = "data_files/train_score_dense_alpaca_user_orient.csv")
    test_input_csv: Optional[str] = field(default = "data_files/train_score_dense_alpaca_user_orient.csv")
...
def main():
    ...
    test_dataset = RewardDataset(script_args.test_input_csv, tokenizer)
